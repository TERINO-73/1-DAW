...
// Función que muestra el contenido del vector con MIENTRAS
Funcion MostrarVM(v,tam)
	Definir i Como Entero
	Escribir "[", v[0] Sin Saltar
	i = 1
...
// Función que muestra el contenido del vector con REPETIR-MIENTRAS
Funcion MostrarVRM(v,tam)
	Definir i Como Entero
	Escribir "{", v[0] Sin Saltar
	i = 1
	Repetir
...
// Función que rellena el vector aleatoriamente con valores entre 10 y 100
// con REPETIR-MIENTRAS
Funcion RellenarRM(v,tam)
	Definir i Como Entero
	i = 0
	Repetir
		v[i]= Azar(91) + 10
...
Algoritmo Examen
	...
	Repetir
		...
		Si op == 1 Entonces
			...
			MostrarV(vector, tam) // con PARA
			MostrarVM(vector, tam) // con MIENTRAS
			MostrarVRM(vector, tam)// con REPETIR-MIENTRAS
		Fin Si
		Si op == 2 Entonces
		...
		Si op == 5 Entonces
			Si ValoresRepetidos(vector, tam) Entonces
				Escribir "El vector tiene valores repetidos: " Sin Saltar
			SiNo
				Escribir "El vector NO tiene valores repetidos: " Sin Saltar
			FinSi
			MostrarV(vector, tam)
		Fin Si
		Si op == 6 Entonces
